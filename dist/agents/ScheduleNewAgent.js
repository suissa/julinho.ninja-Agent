...
exports.ScheduleNewAgent = void 0;
const BaseAgent_1 = require("./BaseAgent");
class ScheduleNewAgent extends BaseAgent_1.BaseAgent {
     ...
     */
    setupDynamicFlow(number, flowType) {
        let dynamicFlow;
        switch (flowType) {
            case 'date-first':
...
exports.ScheduleNewAgent = ScheduleNewAgent;
//# sourceMappingURL=ScheduleNewAgent.js.map