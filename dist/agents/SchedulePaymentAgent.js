...
exports.SchedulePaymentAgent = void 0;
const BaseAgent_1 = require("./BaseAgent");
class SchedulePaymentAgent extends BaseAgent_1.BaseAgent {
     ...
     */
    calculateFinalPrice(originalPrice, paymentMethod) {
     ...
     */
    generateAppointmentSummary(number) {
        try {
...
Obrigado por escolher nossa clínica! 😊
    ...
    processInput(number, input) {
        ...
        try {
            const clientData = this.globalMemory.getClientData(number);
            const originalPrice = clientData.selectedServicePrice || 0;
...
exports.SchedulePaymentAgent = SchedulePaymentAgent;
//# sourceMappingURL=SchedulePaymentAgent.js.map