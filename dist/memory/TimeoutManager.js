...
class TimeoutManager {
    constructor(config, globalMemory) {
     ...
     */
    async handleUserResponseTimeout(number, stage, onTimeout, onReminderTimeout) {
        const sessionTimeout = this.activeTimeouts.get(number);
        if (!sessionTimeout) {
     ...
     */
    async handleFinalTimeout(number, stage, onTimeout) {
        const sessionTimeout = this.activeTimeouts.get(number);
        if (!sessionTimeout) {
            return;
        }
